...
1.  **Planning and methodological development:** Similar to the original
    ...
    2)  prioritizing gaps in current knowledge for inclusion into the
        assessment,
    3)  defining the boundaries of the assessment, and
...
**Main findings (Everyone)**
  ...
  - Climate change scenarios and impacts
      - Use Abatzglouâs data for CONUS -
      ...
      - Land use?
      - Forestry â primarily harvesting patterns and methods
      - Rangelands
      - Wetlands (R. Sleeter?)
      - Agriculture?
      - DOI lands
  ...
  - Planned topics for future assessments
      ...
      - Drought v3 or v4 (Henne and Craig Allenâs team)
